...
approximately 10 percentage points. This is consistent with the dataset design: Medium
was deliberately constructed to overlap with adjacent classes (Section~2.3).
