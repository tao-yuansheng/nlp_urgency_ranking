...
OUT_IMG = os.path.join(SCRIPT_DIR, "results", "error_histogram.png")

def generate_visualization():
    print(f"Loading data from {IN_JSONL}")
    if not os.path.exists(IN_JSONL):
        print("Data file not found. Please ensure icp_pairs.jsonl exists.")
        return
    ...
    # Formatting
    plt.title('DeBERTa Urgency Model: Error Direction Distribution', fontsize=16, pad=15)
